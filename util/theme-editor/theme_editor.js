    ...
    CrayonSyntaxThemeEditor = new function () {
        ...
        base.save = function () {
            ...
            CrayonUtil.postAJAX({
                ...
                id: themeID,
                name: base.getName(),
                _ajax_nonce: $("#crayon-theme-editor-wrap").data( "save-nonce" ),
                css: newThemeStr
            }, function (result) {
                status.show();
            ...
            admin.createDialog({
                ...
                yes: function () {
                    CrayonUtil.postAJAX({
                        ...
                        id: id,
                        _ajax_nonce: $("#crayon-theme-editor-wrap").data( "delete-nonce" ),
                    }, function (result) {
                        if (result > 0) {
                            CrayonUtil.reload();
                        } else {
            ...
            base.createPrompt({
                ...
                ok: function (val) {
                    CrayonUtil.postAJAX({
                        ...
                        id: id,
                        _ajax_nonce: $("#crayon-theme-editor-wrap").data( "duplicate-nonce" ),
                        name: val
                    }, function (result) {
                        if (result > 0) {
                            CrayonUtil.reload();
            ...
            base.createPrompt({
                ...
                ok: function (val) {
                    CrayonUtil.postAJAX({
                        ...
                        id: id,
                        _ajax_nonce: $("#crayon-theme-editor-wrap").data( "submit-nonce" ),
                        message: val
                    }, function (result) {
